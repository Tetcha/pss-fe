...
const OurDoctors: React.FunctionComponent<OurDoctorsProps> = () => {
	return (
		<>
			<div id="testimonials" className="flex items-center justify-center w-full">
				<div className="max-w-container mx-auto">
					<div className="flex-col items-center ">
						<div className="flex flex-col items-center justify-center w-full h-full max-w-2xl pr-8 mx-auto text-center">
							<h2 className="text-2xl md:text-4xl font-bold leading-10 tracking-tight sm:text-5xl sm:leading-none">
								Doctors
							</h2>
							<p className="my-6 text-xl font-medium text-gray-500">
								Dont just take our word for it, read from our extensive list of case studies and
								customer testimonials.
							</p>
						</div>
						<div className="flex flex-col items-center justify-center max-w-2xl py-8 mx-auto xl:flex-row xl:max-w-full">
							<div className="w-full grid grid-cols-1 xl:grid-cols-2 gap-x-10 gap-y-5">
								<blockquote className="flex flex-col-reverse items-center justify-between w-full p-6 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease cursor-pointer">
									<div className="flex flex-col pr-10">
										<div className="relative pl-12">
											...
											<p className="mt-2 text-base text-gray-600">
												Im loving these templates! Very nice features and layouts.
											</p>
										</div>
